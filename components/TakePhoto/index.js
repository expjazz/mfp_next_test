...
class TakePhoto extends React.Component {
  ...
  render() {
    ...
    return (
      <ImageUpload.TakePhotoWrapper className="take-photo-wrp">
        {!imageLoading && (
          <React.Fragment>
            ...
            {!this.state.videoError && (
              <ImageUpload.PhotoButtonWrapper>
                <Button className="button" onClick={this.takeScreenshot}>
                  {this.props.t('common.capture_photo')}
                </Button>
              </ImageUpload.PhotoButtonWrapper>
            )}
          </React.Fragment>
...
export default  withTranslation()(withDisableRefetchOnFocus(TakePhoto));
