    ...
    <Wrapper>
      <Ul ref={containerRef}>
        <React.Fragment>
          ...
          >
            <FlatFeed
              feedGroup="dmfeedone" // or timeline
              notify
              LoadingIndicator={Loader}
              Placeholder={() => {
                return (<EmptyPlaceholder
                  text={t('my_videos.requestEmpty.dm', {talent: entityData?.partnerData?.talentSingleCap})}
                  imageURL='/images/empty_sad.svg'
...
export default withFeedSubscription(Conversation);
