  ...
  const renderComment = type => {
    ...
    if (type === 'fan') {
      ...
      commentDetails.comments = t('common.commercialCard.fanBudget', {
        ...
        amount: numberToDollarFormatter(commercialDetails.fan_budget),
      });
    } else {
    ...
    <React.Fragment>
      ...
      bookItem.commercial_details && bookItem.commercial_details.star_approved && (
        <React.Fragment>
          ...
          <Bold>
            {
              t('common.commercialCard.termsDescription', {
                amount: numberToDollarFormatter(bookItem.commercial_details.star_price)
              })
            }
          </Bold>
        </React.Fragment>
