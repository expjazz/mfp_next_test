    ...
    <ModalWrap isForm={addNew}>
      <Wrap className="content-wrapper">
        ...
        <section className="terms-wrap">
          <Description>
            {
              t('services.liveCall.description', {
            ...
            <div className="terms-modal">
              ...
              <span className="text">
                ...
                values={{
                  ...
                  mailUrl: 'concierge@myfanpark.com'
                }}>
                  Want to brainstorm with a {entity('siteName')} rep? Reach out to
                  <a href="mailto: concierge@myfanpark.com" className="link">
                    concierge@myfanpark.com
                  </a>
                </Trans>
              </span>
              <FlexCenter>
        ...
        {props.entityData.allow_star_share_graphics && props.celebActive && props.adminApproved &&
          props.celbDetails.services.live_call && (
