				...
				{(!props.noPopOver || showShare || props.alwaysActive) && (
					<ListWrapper {...listOptions}>
						<ShareStyled.List ref={popperRef} className="share-list">
							{props.services && props.services.facebook && !isVodacom() ? (
								<li className="list-item">
							...
							{props.services && props.services.twitter && !isVodacom() ? (
								<li className="list-item">
									<TwitterShareButton
										className="social-btn"
										title={getTwitterText(content.title, props.shareUrl)}
										url={props.shareUrl}
										beforeOnClick={() => {
											try {
								...
								<li className="sms-section">
									<Input
										...
										inputProps={{
											...
											labelObj: {
												label: smsErr ? '' : t('common.textNumber'),
												errorMsg: smsErr,
											},
										}}
									/>
									<SecondaryButton
										secondary
										className="sms-btn"
										onClick={sendSms(props.shareUrl)}
									>
										{t('common.send')}
									</SecondaryButton>
								</li>
...
export default DownloadHandler(ShareButton);
