...
const OutterPage = styled.div`
  background-color: ${props => props.theme.superSportLightGray};
  height: fit-content;
  overflow-x: hidden;
  .v3-header {
    background-color: ${props => props.theme.superSportDarkBlue};
  }
  .know-container {
    h3 {
      color: ${props => props.theme.superSportDarkBlue} !important;
    }
  }
...
const SectionTitle = styled.div`
  ...
  .link {
    color: ${props => props.theme.superSportDarkBlue};
...
`
export { HomeStyled as default, TopStarsCarousel, OutterPage, BodyContainer, SectionTitle }