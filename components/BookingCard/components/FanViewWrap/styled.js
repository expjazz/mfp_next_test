...
const horizontalPadding = props => css`
  padding: 0 12px;
...
const BookingStyled = styled.div`
  ...
  @media (min-width: 832px) {
    height: ${props => (props.starMode ? 'auto' : 'calc(100% - 214px)')};
    position: relative;
    .scrollbar-content {
...
BookingStyled.OrderText = styled.span`
  ...
  cursor: pointer;
  margin-top: ${props => (props.starMode ? '14px' : '20px')};
  text-align: center;
