...
function TermsService(props) {
  ...
  return (
    <Wrap headerHeight={headerHeight}>
      ...
      />
      <h2 className="heading">{t('common.about.termsHeading')}</h2>
...
export async function getStaticProps({locale, params: { site }}) {
  ...
  axiosFetch.defaults.headers.common['entity-id'] = entityId
  axiosFetch.defaults.headers.common['entity-token'] = entityToken
