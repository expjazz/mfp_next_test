...
import Resources from 'components/PromotionLayout/components/Resources/Resources';
import HowItWorks from 'components/PromotionLayout/components/HowItWorks/HowItWorks';
import { Wrapper } from 'components/PromotionLayout/styled';
import { getDeliveryPaths } from 'src/utils/getDomainPaths';
function TalentPromotion() {
	return (
		<Wrapper ClassName="Promotion">
			<CommNavbar />
			<Resources />
			<HowItWorks />
			<CommFooter />
...
export default TalentPromotion;
