...
export default async function handler(req, res) {
	...
	const headers = vodacomHeaderConstructor('POST', vodacomApi.inquiryUserInfo, req.body, true);
	try {

		const vodaResponse = 	await vodacomFetch.post(vodacomApi.inquiryUserInfo,
		  req.body
			, {
				headers,
			}
